...
const ThemeToggle = () => {
  ...
  return (
    <div className="flex items-center justify-center w-4/5 p-4 mx-6 space-x-6 rounded bg-lightGrey dark:bg-veryDarkGrey" >
        <Image src="/icon-light-theme.svg" alt="Sun" height={18} width={18} onClick={() => setTheme("light")} />
        <label htmlFor="default-toggle" className="relative inline-flex items-center w-16 cursor-pointer">
